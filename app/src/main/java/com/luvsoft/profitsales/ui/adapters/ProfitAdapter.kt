...
import com.luvsoft.profitsales.ui.adapters.diff.ProfitDiff
...
class ProfitAdapter @Inject constructor(
    ...
    private val diff: ProfitDiff,
    val callbackClick: CallbackClick
) : ListAdapter<ProfitEntity, RecyclerView.ViewHolder>(diff) {

    interface CallbackClick {
        fun onItemClicked(dep: ProfitEntity)
    }
